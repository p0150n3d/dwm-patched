...
static const int vertpad	    = 9;
static const int sidepad	    = 9;
static const char *fonts[]          = { "Lotuscoder:size=10", "FontAwesome:size=10" };
static const char dmenufont[]       = "Lotuscoder:size=10";
